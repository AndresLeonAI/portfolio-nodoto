      ...
      <div class="w-full">
        <div class="text-flax-smoke-50 mt-2 h-full font-normal">
          ...
          <Link
            ...
            tag="p"
            label="contacto@nodoto.agency"
            url="mailto:contacto@nodoto.agency"
          />
  ...
  >
    <nav class="flex justify-between">
      ...
      <div class="flex justify-start">
        <p
          class="heading-6 font-fancy text-flax-smoke-400 hidden font-bold uppercase tracking-widest select-none md:block"
        >
