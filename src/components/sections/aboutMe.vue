  ...
  >
    ...
    <div class="padding-y md:column-gap mt-6 grid grid-cols-12">
      ...
      <div class="col-span-11 mt-10 md:col-span-8 md:col-start-6">
        ...
        >
          El internet actual sufre de obesidad visual y estandarización. Rechazamos el diseño genérico. Somos arquitectos de comportamiento humano enfocados en la neuro-conversión extrema.
        </p>
...
<script setup lang="ts">
  ...
  onBeforeMount(() => {
    aboutMe.value = textSplitterIntoChar(
      'Neuro-Diseño, Autoridad, Conversión/',
      true,
      true,
    );
  });
