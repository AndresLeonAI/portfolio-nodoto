<template>
  ...
  >
    <div
      class="flex-center relative h-[92dvh] w-full flex-col rounded-lg bg-black uppercase"
    >
      <video
      ...
      <div class="flex-center z-10 flex-col gap-y-10">
        ...
        >
          El mercado no perdona el diseño promedio. Eleva tu conversión.
        </p>
        <h3
          id="make-it-happen"
        ...
        >
          <!-- <Button
            ...
            label="Get in touch"
          /> -->
          <Button label="Agenda un Discovery" @click="router.push('/discovery')" />
        </div>
      </div>
      <div
