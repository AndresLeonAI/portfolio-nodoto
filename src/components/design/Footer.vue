  ...
  >
    ...
    <div class="grid w-full grid-cols-12">
      <div class="col-span-7 place-content-center md:col-span-6">
        <h6 class="heading-4 sm:heading-2 leading-none font-bold uppercase">
          © {{ new Date().getFullYear() }} NODOTO <br />
          Derechos Reservados.
        </h6>
      </div>
      ...
      >
        <p class="heading-6 font-bold uppercase">NODOTO HQ Time</p>
        <p class="heading-6">{{ myLocalTime }}</p>
        <p class="heading-6 font-bold uppercase">Tu hora local</p>
